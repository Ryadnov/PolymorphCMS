...
class HTTP_ConditionalGet {
     ...
     * content (only HTTP1.2 clients can conditionally GET). The given string
     ...
     * code header: array('_responseCode' => 'HTTP/2.0 304 Not Modified')
     * 
    ...
    protected function _isCacheValid()
    {
        ...
        if ($isValid) {
            $this->_headers['_responseCode'] = 'HTTP/2.0 304 Not Modified';
        }
        return $isValid;
    }
