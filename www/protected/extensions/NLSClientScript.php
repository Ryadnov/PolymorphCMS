...
History:
2.2
 - dirty fix script rendering bug of jquery.js v1.6.2 affecting binline=true mode
2.0
...
2. in /protected/config/main.js, configure the 'clientScript' component:
'clientScript' => array(
 ...
 *     - there may be problem if the names of two different resource files used in the same views are equal
 *      ( eg. two different "main.js" in the same views)
...
**/
	private function getResourceContent($f) {
		...
		//dirty fix script rendering bug of jquery.js v1.6.2
...
**/
	...
	public function renderBodyEnd(&$output)
	{
		...
		$fullPage=0;
		$output=preg_replace('/(<\\/body\s*>)/is','<###end###>$2',$output,1,$fullPage);
		$html='';
