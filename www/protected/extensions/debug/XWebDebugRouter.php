 ...
 *      'allowedIPs'=>array('127.0.0.2','192.168.2.54','192\.168\.2[0-1]\.[0-9]{2}'),
 * 		),
 * ),
 * [...]
 *
 ...
 * the toolbar anyway.
 * AllowedIPs be defined as a preg regexps ie: '192\.168\.2[0-1]\.[0-9]{2}'
 */
...
/**
 * Render debug panel to document using views and configuration parameters
 */
class yiiDebugPanel
{
...
{
	public $config = '';
	public $allowedIPs = array('127.0.0.2');
