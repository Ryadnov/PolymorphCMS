...
if ((isset($_POST['action']) ? $_POST['action'] : (isset($_GET['action']) ? $_GET['action'] : '')) == 'simple') {
    ...
    if ($handle->uploaded) {
        ...
        // -----------
        $handle->image_crop            = '1 20%';
        TestProcess($handle, '5px vertical and 20% horizontal crop', "\$foo->image_crop            = '1 20%';");
        ...
        // -----------
        $handle->image_crop            = '1 40 10% -20';
        TestProcess($handle, '5px top, 40px right, 10% bot. and -20px left crop', "\$foo->image_crop            = '1 40 10% -20';");
        ...
        TestProcess($handle, 'flat colored frame, 4 px wide, 25% opacity', "\$foo->image_frame           = 2;\n\$foo->image_frame_colors    = '#FF0000 #FF00FF\n                               #0000FF #000000';\n\$foo->image_frame_opacity   = 25;");
        ...
        TestProcess($handle, '1% overlay #0000FF', "\$foo->image_overlay_color   = '#0000FF';\n\$foo->image_overlay_opacity = 1;");
        ...
        // -----------
        $handle->image_unsharp         = true;
        $handle->image_unsharp_amount  = 100;
        $handle->image_unsharp_radius  = 50;
        $handle->image_unsharp_threshold = 0;
        TestProcess($handle, 'unsharp mask, different values', "\$foo->image_unsharp         = true;\n\$foo->image_unsharp_amount  = 100;\n\$foo->image_unsharp_radius  = 50;\n\$foo->image_unsharp_threshold = 0;");
