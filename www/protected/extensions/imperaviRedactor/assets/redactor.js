	...
	Construct.prototype = {
		...
		*/	
		...
		{				
			...
			// flash replace
			html = html.replace(/\<object([\w\W]*?)\<\/object\>/gi, '<p class="redactor_video_box"><object$2</object></p>');
		...
		getEditorDoc: function(html)
		{
	    	...
	    	var frameHtml = '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 2.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">\n';
...
var contOwnLine=['li', 'dt', 'dt', 'h[2-6]', 'option', 'script'];
