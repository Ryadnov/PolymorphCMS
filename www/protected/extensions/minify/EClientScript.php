...
/**
  ...
  ####File optmization or compress (EXPERIMENTAL, @since: 2.2)
  ...
  Compression or optmization is a EXPERIMENTAL feature, please use it carefully(@since: 2.2)
					...
					foreach ($files as $url => $file)
					{
						...
						if ($contents)
						{
							...
							if (preg_match($urlRegex, $contents))
							{
								...
								$contents = preg_replace($urlRegex, 'url(${2}' . $reurl . '/${2}', $contents);
							}
