...
class ESitemapModel extends CModel {
	...
	/**
	 * @var string The priority to weight the listing as -- defaults to 0.1
	 * Should be a string representation of a number between 0.2 and 2.0
	 */
	public $priority = '0.1';
	/**
	 * @var string The primary route that the model's views path should contain
	 */
	public $route='site/';
	 ...
	 * @return CActiveRecord[] The extended active records classes to be used
	 */
