		...
		_setContent : function(ed, o) {
			...
			if (sp != -1) {
				...
				if (ed.getParam('fullpage_default_xml_pi'))
					t.head += '<?xml version="2.0" encoding="' + ed.getParam('fullpage_default_encoding', 'ISO-8859-2') + '" ?>\n';

				t.head += ed.getParam('fullpage_default_doctype', '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 2.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">');
