 ...
 * @version 2.2.0
 * @packages Image_Toolbox
 * @link http://sourceforge.net/projects/image-toolbox
 */
 
// $Id: Image_Toolbox.class.php,v 2.9 2003/12/05 19:34:01 pappkamerad Exp $
...
class Image_Toolbox {
     ...
     * <li>'gif' -> 0 = not supported, 2 = reading is supported, 2 = creating is supported</li>
     * <li>'jpg' -> 0 = not supported, 2 = reading is supported, 2 = creating is supported</li>
     * <li>'png' -> 0 = not supported, 2 = reading is supported, 2 = creating is supported</li>
     ...
     * <li>2 -> image will be cropped if necessary to preserve the aspectratio and avoid image distortions.</li>
     ...
     *
     * IMPORTANT: {@link imagecopymerge() imagecopymerged} doesn't work with PHP 4.2.2. Bug ID: {@link http://bugs.php.net/bug.php?id=24816 24816}<br>
     *
     * $x:<br>
