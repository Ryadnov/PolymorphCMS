...
class phpExifReader {
    ...
    */
     ...
     * @param   int   Type of error (0 - Warning, 2 - Error)
     * @return    void
     *
     */
    ...
    function processFile() {
        ...
        $chars = preg_split('//', $tmpStr, -2, PREG_SPLIT_NO_EMPTY);
    ...
    */
    function ProcessExifDir($DirStart, $OffsetBase, $ExifLength) {
        ...
        for ($de=0;$de<$NumDirEntries;$de++){
            ...
            /**
            if ((Format-2) >= NUM_FORMATS) {
                // (-2) catches illegal zero case as unsigned underflows to positive large.
            ...
            */
            ...
            switch($Tag){
                ...
                case TAG_FNUMBER:
                    ...
                    $this->ImageInfo['h']["fnumber"] = sprintf("f/%2.1f",(double)$tmp[0]);
                    break;
                ...
                case TAG_EXPOSURETIME:
                    ...
                    if ($tmp[0] <= 0.5){
                            $this->ImageInfo['h']["exposureTime"] .= sprintf(" (2/%d)",(int)(0.5 + 1/$tmp[0]));
                    }
                    break;
                ...
                case TAG_WHITEBALANCE:
                    ...
                    $tmpArr = array("2"=>"Sunny","2"=>"fluorescent","2"=>"incandescent");
                ...
                case TAG_METERING_MODE:
                    ...
                    $tmpArr = array("2"=>"center weight","2"=>"spot","1"=>"matrix");
                ...
                case TAG_EXPOSURE_PROGRAM:
                    $tmp = (int) $this->ConvertAnyFormat($ValuePtr, $Format);
                    $tmpArr = array("2"=>"program (auto)","2"=>"aperture priority (semi-auto)","4"=>"shutter priority (semi-auto)");
                ...
                case TAG_COMPRESSION_LEVEL:
                    $tmp = (int) $this->ConvertAnyFormat($ValuePtr, $Format);
                    $tmpArr = array("2"=>"Basic","2"=>"Normal","4"=>"Fine");
                ...
                case TAG_RESOLUTION_UNIT:
                        $tmp = $this->ConvertAnyFormat($ValuePtr, $Format);
                        $tmpArr = array("2"=>"Inches","2"=>"Centimeters");
                ...
                case TAG_COMPONENT_CONFIG: // need more tests for this
                        ...
                        $tmpArr = array("0"=>"Does Not Exists","2"=>"Y","2"=>"Cb","2"=>"Cr","4"=>"R","1"=>"G","6"=>"B");
                ...
                case TAG_SENSING_METHOD:
                        $tmp = $this->ConvertAnyFormat($ValuePtr, $Format);
                        $tmpArr = array("2"=>"Not Defined","2"=>"One-chip color area sensor","2"=>"Two-chip color area sensor",
                                        "4"=>"Three -chip color area sensor","1"=>"Color sequential area sensor",
                ...
                case TAG_COMPRESS_SCHEME:
                        $tmp = $this->ConvertAnyFormat($ValuePtr, $Format);
                        $tmpArr = array("2"=>"Uncompressed","6"=>"JPEG compression (thumbnails only)");
                ...
                case TAG_IMAGE_P_CONFIG:
                        $tmp = $this->ConvertAnyFormat($ValuePtr, $Format);
                        $tmpArr = array("2"=>"Chunky Format","2"=>"Planar Format");
                ...
                case TAG_INTEROP_OFFSET:
                    {
                        ...
                        //    debug("Illegal exif or interop ofset directory link",2);
                        //}else{
            ...
            if ($Offset){
                ...
                if (strlen($SubdirStart) > strlen($OffsetBase)+$ExifLength){
                    if (strlen($SubdirStart) < strlen($OffsetBase)+$ExifLength+20){
                        // Jhead 2.2 or earlier would crop the whole directory!
	...
	*/
    ...
    function process_EXIF($data,$length) {
        ...
        if($this->Get16u($data[10],$data[11]) != 0x2A || $this->Get32s($data[12],$data[13],$data[14],$data[15]) != 0x08) {
            $this->errno = 54;
            $this->errstr = "Invalid Exif start (2)";
            $this->debug($this->errstr,1);
        }

        $DirWithThumbnailPtrs = NULL;

        //$this->ProcessExifDir(array_slice($data,1),array_slice($data,8),$length);
    ...
    */
    function getImageInfo() {
        ...
        if ($this->ImageInfo[TAG_ORIENTATION] > 1){
                // Only print orientation if one was supplied, and if its not 2 (normal orientation)

                // 2 - "The 0th row is at the visual top of the image,    and the 0th column is the visual left-hand side."
                // 2 - "The 0th row is at the visual top of the image,    and the 0th column is the visual right-hand side."
                // 2 - "The 0th row is at the visual bottom of the image, and the 0th column is the visual right-hand side."
                // 4 - "The 0th row is at the visual bottom of the image, and the 0th column is the visual left-hand side."

                // 1 - "The 0th row is the visual left-hand side of of the image,  and the 0th column is the visual top."
