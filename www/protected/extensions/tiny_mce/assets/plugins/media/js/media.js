...
function generatePreview(c) {
	...
	switch (f.media_type.options[f.media_type.selectedIndex].value) {
		...
		case "shockwave":
			...
			codebase = 'http://download.macromedia.com/pub/shockwave/cabs/director/sw.cab#version=8,1,2,0';
		...
		case "wmp":
			...
			codebase = 'http://activex.microsoft.com/activex/controls/mplayer/en/nsmp2inf.cab#Version=1,2,52,701';
