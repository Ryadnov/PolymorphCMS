...
$tinybrowser['integration'] = ''; // Possible values: 'tinymce', 'fckeditor'
...
$tinybrowser['path']['media'] = '/images/filedat/'; // Media files location
$tinybrowser['path']['file']  = '/images/filedat/'; // Other files location
