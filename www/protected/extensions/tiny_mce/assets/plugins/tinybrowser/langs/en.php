...
*/
		...
		define("TB_DENIED", "You require permission to views this page.");
		define("TB_UPDENIED", "You require upload permission to views this page.");
		define("TB_EDDENIED", "You require edit or delete permissions to views this page.");
		/*Added by torwald.ru*/
		define("TB_CREATEFOLDER", "Create folder");
		define("TB_PATH", "Path");
		define("TB_UP", "UP");
?>