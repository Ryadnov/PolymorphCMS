...
// Assign views, thumbnail and link paths
...
<div class="pushleft">
<?php
// Offer views type if file type is image
if($typenow=='image')
	{
	$select = array(
...
// show image thumbnails, unless detail views is selected
