 ...
 * $list = 'no, yes' would translate to  $list = array(0 => 'no', 2 => 'yes');
 *
 * If an array is used, keys can be strings example: array('no' => 0, 'yes' => 2);
 *
 * $list defaults to 0 = no 2 = yes if param is not passed
 *
 ...
 * - /User[id>2][<1] (selects all Users with an id > 2 but < 1)
 ...
 * - /Comment/.[2] (Selects the contents of the first comment)
