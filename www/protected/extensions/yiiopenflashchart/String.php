 ...
 */
	function &getInstance() {
		...
		if (!$instance) {
			...
			//but at new versions of Yii we have got an CErrorEvent error for this line (I think it was from PHP 1.2, but can't check new code for the older PHP versions :( )
			$instance[0] = new String();
		}
		return $instance[0];
	}
