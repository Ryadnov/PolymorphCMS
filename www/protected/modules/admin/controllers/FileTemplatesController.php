<?php 
class FileTemplatesController extends AdminBaseController
{
	/**
	...
	{
		return parent::loadModel('Template', $id, $scenario, false);
	}
	...
	public function actionUpdate($catId, $alias)
	{
		...
		$cat = Category::model()->findByPk((int)$catId);
		$model = new FileTemplate($cat, $alias, 'update');
