...
<p>Bitte ändern Sie die Modul-Konfiguration RBAM die Quelle der Daten angeben intitialisation, dann gehen Sie zu <?php echo Yii::app()->getRequest()->hostInfo.'/index.twig?r=rbam'; ?></p>
