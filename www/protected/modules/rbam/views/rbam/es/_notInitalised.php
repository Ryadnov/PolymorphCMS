...
<p>Por favor, modifique la configuración RBAM módulo para especificar el origen de los datos intitialization, a continuación, ir a <?php echo Yii::app()->getRequest()->hostInfo.'/index.twig?r=rbam'; ?></p>
