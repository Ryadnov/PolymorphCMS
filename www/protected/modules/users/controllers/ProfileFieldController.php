...
class ProfileFieldController extends AdminBaseController
{
	...
	public static function getWidgets($fieldType='') {
		$basePath=Yii::getPathOfAlias('application.modules.users.components');
		$widgets = array();
		$list = array(''=>Users::t('No'));
		if (self::$_widgets) {
