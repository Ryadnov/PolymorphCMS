...
return array(
	...
	'Incorrect username (length between 2 and 20 characters).' => 'Μη αποδεκτό όνομα χρήστη  (από 2 έως 20 χαρακτήρες).',
      'Incorrect First Name (length between 2 and 50 characters).' => 'Μη αποδεκτό όνομα χρήστη  (από 2 έως 20 χαρακτήρες).',
	...
	'Widgets'=>'Widgets',
	'Widgets parametrs'=>'Παράμετροι Widgets ',
	'Widgets name.'=>'Όνομα Widgets',
